...
<html>
<head>
<jsp:useBean id="c1" class="chitkara.operation.UserOperation"></jsp:useBean>
...
<br><br>
 <table class="table table-borderless ">
    ...
    <thead>
      <tr>
   <th><h1>Users ::</h1></th></tr><tr>
 <% ResultSet rs=c1.showUsers();
    ...
    <tbody>
      ...
      <tr><th><td><font color="white">hi</td></th></tr>
    <%} %>
    </tbody>
  </table>
</div>
