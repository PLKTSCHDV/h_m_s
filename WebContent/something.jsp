...
<div id="myNav" class="overlay" style="margin-top:2%">
  ...
  <div class="overlay-content">
    ...
    <a href="dashboard.jsp">Profile<i class="glyphicon glyphicon-user" style="margin-left:20%"></i></a>
...
<div class="col-sm-8">
	...
	<div class="container">
		<div class="header">
		<center><h1 style="margin-top: 7%;margin-left: 7%;position:fixed">ADD COMPLAINTS</h1></center>
		</div>
        	<form class="form-horizontal" action="addcomplaint" style="margin-top: 12%;width:70%;position:fixed;">
    ...
    <div class="form-group">
      <label class="control-label col-sm-2" for="email">Your Complaint:</label>
      <div class="col-sm-10">
      <textarea style="width:100%" rows="10" placeholder="Add Complaints" name="complaint"></textarea></div></div>
